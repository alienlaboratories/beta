...
import { QueryProcessor } from 'alien-core';
...
export class SlackQueryProcessor extends QueryProcessor {
  ...
  /**
   * Get a (possibly synthetic) Alien Contact item for each slack user.
   * If a corresponding Alien User object can be found (matching on email), include it as contact.user.
   *
